// Views/RoadMapView.swift

import SwiftUI
import MapKit

struct RoadMapView: UIViewRepresentable {
    ...
    private func updateOverlays(on mapView: MKMapView) {
        ...
        if !areOverlaysEqual(currentOverlays, overlays) {
            ...
            print("Road Overlays updated on map.")
        }
    }
    ...
    private func updateAnnotations(on mapView: MKMapView) {
        ...
        if !areAnnotationsEqual(currentAnnotations, annotations) {
            ...
            print("Road Annotations updated on map.")
        }
    }
    ...
    func makeCoordinator() -> RoadMapViewCoordinator {
        RoadMapViewCoordinator(self)
    }
}
